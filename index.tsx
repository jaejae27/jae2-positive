...
[출력 규칙]
1. 형식: [형용사] [명사] 에너지 (최대한 짧고 명확하게)
2. 길이: 공백 포함 **12자 이내**로 엄격히 제한해.
3. 🚫 금지 단어: 엔진, 발전소, 발전기, 연료, 탱크, 기계, 무지개, 구름 (기계적/추상적 표현 금지)
4. 톤: 아이들이 멋있다고 느낄만한 '정체성' 위주로 작명해.

[변환 가이드]
- 사용자가 선택한 키워드의 긍정적 의도를 파악하여 '정체성'이 드러나게 지어줘.
- 예시:
  - (산만함) → 호기심 많은 탐험 에너지
  - (고집) → 주관이 뚜렷한 소신 에너지
  - (느림) → 차분하고 꼼꼼한 완벽 에너지
